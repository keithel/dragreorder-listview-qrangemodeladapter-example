...
- **Drag cancellation:** Cancel drag operations via ESC key (desktop) or second finger press (touch devices). See [DRAG_CANCELLATION.md](docs/DRAG_CANCELLATION.md) for details.
